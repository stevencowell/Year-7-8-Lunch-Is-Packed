const COURSE_VIDEOS = (() => {
  const modules = {
    ...
    8:{id:'cmBf1fBRXms',title:'Convergent Thinking Versus Divergent Thinking',channel:'John Spencer',purpose:'Use sampling to explore decorative possibilities before committing.',watch:['Connect exploration to colour, placement and technique.','Notice why selection needs evidence.','Identify the role of refinement after testing.']},
    9:{id:'KUaanhs5quU',title:'How to Thread a Brother Sewing Machine',channel:'Brother Sews USA',purpose:'Observe how an accurate setup supports later quality control.',watch:['Notice the sequence and checkpoints.','Identify steps that should happen before power is used.','Connect careful setup to stitch quality.']},
